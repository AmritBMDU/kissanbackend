                     ...
                     <table class="table responsive-table">
                         ...
                         <tbody>
                           ...
                           <div class="select">
                              ...
                              <button  class="btn btn-warning"><option selected disabled>Pending </option></button>   
                                 <option value="txt"><span class="text-success"></span>Approved</option>
                                 <option value="fb2"><span class="text-primary">Suspended</span></option>
                                 <option value="epub"><span class="text-warning"> Block </span></option>
