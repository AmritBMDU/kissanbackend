      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2" style="position: relative; top: 50px;">
             <a href="add-new-product.php"><button class="btn " type="submit" style="padding: 8px 20px; font-size:12px;">+ Add New Product</button></a>       
                     ...
                     <table class="table responsive-table">
                         ...
                         <tbody>
                           <tr>
                              ...
                              <td class="col-3 ">
                                 <p class="pt-3">Series Name</p>
                              
                               </td>
                              <td class="col-3 ">
                                <p class="pt-3">Categories Name</p>
                             
                              </td>
                              <td class="pt-4">01/04/2023</td>
                              <td class="col-2 pt-4">
                              Product Name
                              </td> 
                              <td class="col">
                                 <div class=" d-flex mt-3 ">
                                  <div class="edit  me-2">
                                  <a href="edit-product.php"><i class="fa-solid fa-pen-to-square"></i></a>
                                  </div>
                         ...
                         <tr>
                           ...
                           <td class="pt-4 col-2">01/04/2023</td>
                           <td class="col-2 pt-4">
                           Product Name
                           </td> 
                           <td class="col">
