    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2" style="position: relative; top: 50px;">
                <div class="Click-here"> <button class="btn " type="submit" style="padding: 8px 20px; font-size:12px; margin-left:-10px">+
                    ...
                    <div class="col">
                       ...
                       <tr>
                                    ...
                                    <td class="col-2 ">
                                        ...
                                        <img src="assets/images/avatar-1.png" class="img-fluid" style="width:50px;"
                                            alt="">
