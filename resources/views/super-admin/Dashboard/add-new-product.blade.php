...
<!-- headr-file-start -->
   <div class="content-wrapper">
    ...
    <div class="col-12">
        ...
        <div class="col-md-4"><input type="text" class="form-control mt-3" id="exampleFormControlInput1" placeholder="SKU Code"> </div> 
        ...
        <input type="file" class="form-control d-none" id="customFile1" />
          ...
          <div class="row mt-5">
              <div class="col-6 mb-5 d-flex">
                          ...
                          <button class="add-btn-busi px-3 me-3">Add</button>
